...
$cVat = number_format($vat);
$cSum = number_format($total_price + $vat);
$cTextSum = convertMoneyToText($cSum);
        ...
        <tr>
            <td style="border: 1px solid black; width:60%">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td style="width:320px;text-align:left;">ที่อยู่ : {$currentSaleBuy['customer_address']}</td>
                        </tr>
                        <tr>
            ...
            <td style="border: 1px solid black; width:40%">
                    <table>
                        <tr>
                            <td style="width:120px;text-align:left;">เล่มที่ {$currentSaleBuy['sid']}</td>
                            <td style="width:160px;text-align:left;">เลขที่ {$currentSaleBuy['run_number']}</td>
                        </tr>
                        <tr>
                            <td style="width:120px;text-align:left">วันที่ {$dateNow}</td>
