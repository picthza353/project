                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown-a"
                            data-toggle="dropdown">ข้อมูลผู้ใช้งาน</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown-a"
                            data-toggle="dropdown">ข้อมูลสินค้า</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown-a"
                            data-toggle="dropdown">การนัดหมาย</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown-a"
                            data-toggle="dropdown">ข้อมูลอื่นๆ</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown-a"
                            data-toggle="dropdown"><?php echo $user["firstname"];?> <?php echo $user["lastname"];?></a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                            ...
                            <a class="dropdown-item"
                                href="category_product.php?categories_id=<?php echo $dataMenuCate["id"];?>"><?php echo $dataMenuCate["cate_name"];?></a>
                            <?php } ?>
                            <?php } ?>
                        </div>
                    </li>
