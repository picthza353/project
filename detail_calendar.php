        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            ...
            <?php if($_SESSION["id"] != "" && !empty($_SESSION["id"])){ ?>
              <?php if($currentAppointment["users_id"] == $_SESSION["id"]) {?>
                <div class="row">
                  <div class="col-md-12">
          ...
          <?php if($_SESSION["role"] == 1){?>
            <div align="center">
              <div class="submit-button" >
                <a href="calendar_appointment.php" class="btn btn-danger">ย้อนกลับ</a>
          ...
          <?php } ?>
                ...
                <div align="center">
                  <div class="submit-button" >
                    <a href="edit_appointment.php" class="btn btn-danger">ย้อนกลับ</a>
                    <div class="clearfix"></div> 
                  </div>
                </div>
                <?php } ?>
            ...
            <div align="center">
              <div class="submit-button" >
                <a href="sale_at_store.php" class="btn btn-danger">ย้อนกลับ</a>
                <div class="clearfix"></div> 
              </div>
            </div>
                <?php } ?>
